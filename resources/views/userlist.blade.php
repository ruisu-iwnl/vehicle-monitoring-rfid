...
@section('content')
    <div class="container mx-auto">
        <h1 class="text-3xl font-bold mb-6">table with CRUD OPERATIONS</h1>
        <p class="text-lg text-gray-700">ability to add, update and delete users</p>
        <p class="text-lg text-gray-700">add pagination to the table max of 5 pages</p>

        <div class="mt-8">
            <h2 class="text-2xl font-semibold mb-4">potential data stuff [placeholder muna]</h2>
