...
<div class="container text-center mb-8">
    ...
    <h2 class="mt-4 text-2xl">User Registration</h2>
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-lg">
        <main class="py-4">
            <form>
                <div class="mb-4">
                    <label for="employee-number" class="block text-gray-700 text-sm font-bold mb-2">Employee Number</label>
                    <input type="text" id="employee-number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Example: Emp123456">
                </div>
                <div class="mb-4">
                ...
                <!-- Captcha Code here -->
                <div class="mb-4">
                    <a href="{{ url('userlogin') }}" class="bg-blue-700 text-white py-2 px-4 rounded hover:bg-blue-500 focus:outline-none focus:shadow-outline w-full text-center block">Register</a>
                </div>
                <div class="text-center">
                    <a href="{{ url('') }}" class="text-blue-500 hover:text-blue-700 text-sm block">Back to Landing Page</a>
                    <p class="mt-4 text-sm">Already have an account? <a href="{{ url('userlogin') }}" class="text-blue-500 hover:text-blue-700">Login</a></p>
                </div>
            </form>
        </main>
    </div>
